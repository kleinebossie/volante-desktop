...
describe('storage.ts', () => {
  ...
  describe('readData', () => {
    ...
    it('handles errors gracefully and returns null', async () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith('[storage] Failed to read "test.json"');
      expect(result).toBeNull();
    });
  });
  ...
  describe('writeData', () => {
    ...
    it('handles errors gracefully', async () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith('[storage] Failed to write "test.json"');
    });
  });
});
