...
1. **The "Plan First" Rule**: If a feature sounds complex, prompt the AI: *"I want to build [Feature]. Read ARCHITECTURE.md and list exactly which files you plan to modify. Do not write code yet."* Review the plan. If it's touching files it shouldn't, tell it to find a less intrusive way.
